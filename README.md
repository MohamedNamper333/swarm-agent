...
A collaborative AI swarm for OpenCode: 9 specialized workers + 2 vision agents, 1082 core skills, and an auto-verdict pipeline.
...
- **1082 core skills** in `~/.config/opencode/skills/`
- **92 vault skills** in `~/.config/opencode/skill-libraries/`
