...
description: "Pointer to a library of 17 specialized Game Development skills. Use when working on game-development-related tasks."
risk: none
---

# Game Development Capability Library 🎯

This is a **pointer skill**. The 17 specialized Game Development skills are stored in a hidden vault to keep your startup context minimal.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/kali/.config/opencode/skill-libraries/game-development/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/kali/.config/opencode/skill-libraries/game-development`
