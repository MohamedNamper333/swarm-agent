...
description: "Pointer to a library of 20 specialized Testing skills. Use when working on testing-related tasks."
risk: none
---

# Testing Capability Library 🎯

This is a **pointer skill**. The 20 specialized Testing skills are stored in a hidden vault to keep your startup context minimal.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/kali/.config/opencode/skill-libraries/testing/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/kali/.config/opencode/skill-libraries/testing`
