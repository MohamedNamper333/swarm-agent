...
This is an **execution skill** for the Innovator worker. Use when coordinator detects Vercel token in environment. Returns deployment URL as structured output.
