...
description: "Pointer to a library of 27 specialized Api Integration skills. Use when working on api-integration-related tasks."
risk: none
---

# Api Integration Capability Library 🎯

This is a **pointer skill**. The 27 specialized Api Integration skills are stored in a hidden vault to keep your startup context minimal.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/kali/.config/opencode/skill-libraries/api-integration/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/kali/.config/opencode/skill-libraries/api-integration`
