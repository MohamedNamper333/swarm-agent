...
metadata:
  version: "1.2.0"
  author: vercel
  swarm-worker: architect|reviewer
  model-hint: nemotron-3-ultra-free|ollama-cloud/nemotron-3-super|hy3-free
  requires-cli: vercel
...
This skill runs on **Architect** (for analysis/recommendations) or **Reviewer** (for audit). Coordinator routes here for Vercel cost/performance tasks. Returns ranked recommendations as structured JSON.
