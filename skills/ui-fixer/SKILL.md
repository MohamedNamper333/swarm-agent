...
Priority fixes:
- layout breakage, invisible controls, broken navigation
- form validation, submission feedback, input state
- accessibility violations (focus, labels, contrast, keyboard)
- visual regressions from recent component changes
