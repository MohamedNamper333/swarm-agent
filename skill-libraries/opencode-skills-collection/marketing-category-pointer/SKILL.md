...
description: "Pointer to a library of 50 specialized Marketing skills. Use when working on marketing-related tasks."
risk: none
---

# Marketing Capability Library 🎯

This is a **pointer skill**. The 50 specialized Marketing skills are stored in a hidden vault to keep your startup context minimal.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/kali/.config/opencode/skill-libraries/marketing/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/kali/.config/opencode/skill-libraries/marketing`
