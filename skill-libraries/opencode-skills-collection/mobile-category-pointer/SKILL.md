...
description: "Pointer to a library of 22 specialized Mobile skills. Use when working on mobile-related tasks."
risk: none
---

# Mobile Capability Library 🎯

This is a **pointer skill**. The 22 specialized Mobile skills are stored in a hidden vault to keep your startup context minimal.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/kali/.config/opencode/skill-libraries/mobile/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/kali/.config/opencode/skill-libraries/mobile`
