...
This is an **execution skill** for the Innovator worker. Coordinator routes here when user asks to deploy. Returns deployment URL + claim URL as structured output.
